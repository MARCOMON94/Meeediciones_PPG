...
## Corpus Check
- 63 files · ~112,637 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 989 nodes · 2833 edges · 56 communities (39 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 62 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c33d486`
...
Cohesion: 0.08
Nodes (62): Counter, AnalysisConfig, SensorConfig, block_bpm(), bpm_from_peak_indices(), compute_ac_dc(), detect_artifacts(), estimate_bpm_autocorr() (+54 more)
...
Cohesion: 0.13
Nodes (3): _manual_reference_bpm(), PPGSuite, AppMode

### Community 6 - "atomic_write_json"
Cohesion: 0.17
Nodes (15): main(), _batch_created_at(), _parse_datetime(), purge_expired_trash(), datetime, Path, _relative_trash_path(), TrashBatch (+7 more)
...
Cohesion: 0.13
Nodes (5): PenStyle, _as_float(), _as_ref_pulse(), _mean_ref_pulse(), ndarray

### Community 12 - "relations_window.py"
Cohesion: 0.07
Nodes (48): DictWriter, active_temp_channels_for_animal(), animal_label(), default_mapping_for_animal(), default_position_for_animal(), display_mapping(), display_position(), inverted_mapping_for_animal() (+40 more)
...
### Community 16 - ".value"
Cohesion: 0.21
Nodes (5): _cap_first(), _csv_row_count(), _mean_clinical_ref_pulse(), _mode_label(), Reference BPM for Bland-Altman: mean of pulsioximeter/fonendo final readings onl
...
Cohesion: 0.15
Nodes (3): Path, QModelIndex, QTableWidgetItem
...
Cohesion: 0.17
Nodes (10): AnimalMeasurement, AnimalSelectionRecord, _base_from_row(), make_window(), Path, test_animal_table_row_selection_uses_animal_key_from_checkbox_metadata(), test_recommended_alerts_exclude_measurements_without_stable_bpm(), test_remove_capture_rows_from_sessions_uses_atomic_rewrite() (+2 more)
...
- **Why does `RelationExplorerWindow` connect `RelationExplorerWindow` to `SensorConfig`, `AppController`, `CaptureRecord`, `_as_float`, `relations_window.py`, `.value`, `DictTableModel`, `_read_csv`?**
...
- **Why does `AnimalsWindow` connect `AnimalsWindow` to `AppController`, `relations_window.py`, `.select_animal`, `.populate_animal_list`, `AnimalPhotoCell`, `test_animals_window.py`, `.update_photo`, `CollapsibleSection`?**
