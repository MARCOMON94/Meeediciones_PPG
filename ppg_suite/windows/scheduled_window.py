...
class ScheduledConfigWindow(PPGSuite):
    ...
    def build_ui(self):
        ...
        form.addRow("Temp. manual inicio (C):", self.temp_manual_initial_widget)
    ...
    def start_scheduled_capture(self):
        ...
        st.temp_manual_initial_by_position = self.current_manual_initial_temps()
        st.temp_manual_initial_c = self.manual_initial_temp_summary(st.temp_manual_initial_by_position)
        ...
        try:
            ...
            pass
        self.open_raw_file()
        self.scheduled_segments.append(ScheduledSegment(
            first_step, 0, 0,
            pulse_prev=st.pulse_prev,
            temp_manual_initial_c=st.temp_manual_initial_c,
            temp_manual_initial_by_position=dict(st.temp_manual_initial_by_position),
        ))
    ...
    def apply_scheduled_step(self, index: int):
        ...
        try:
            ...
            pass
        self.scheduled_segments.append(ScheduledSegment(
            step, index, len(self.state.t),
            pulse_prev=self.state.pulse_prev,
            temp_manual_initial_c=self.state.temp_manual_initial_c,
            temp_manual_initial_by_position=dict(self.state.temp_manual_initial_by_position),
        ))
        self.send_command("START_CONTINUOUS")
        self.scheduled_step_start_wall = time.time()
        ...
        with open(raw_file, "w", newline="", encoding="utf-8") as f:
            ...
            for i in range(t.size):
                ...
                w.writerow([
                    ...
                    segment.pulse_prev, segment.temp_manual_initial_c,
                    segment.temp_manual_initial_by_position.get("RT", ""), segment.temp_manual_initial_by_position.get("LT", ""),
        ...
        with open(summary_file, "w", encoding="utf-8") as f:
            json.dump({
                ...
                "manual_reference": {
                    ...
                    "temperatura_manual_inicio_por_posicion_c": segment.temp_manual_initial_by_position,
                    "temperatura_manual_inicio_rt_c": segment.temp_manual_initial_by_position.get("RT", ""),
                    "temperatura_manual_inicio_lt_c": segment.temp_manual_initial_by_position.get("LT", ""),
                    "temperatura_manual_inicio_frt_c": segment.temp_manual_initial_by_position.get("FRT", ""),
                    "temperatura_manual_inicio_flt_c": segment.temp_manual_initial_by_position.get("FLT", ""),
                    "temperatura_manual_inicio_rrt_c": segment.temp_manual_initial_by_position.get("RRT", ""),
                    "temperatura_manual_inicio_rlt_c": segment.temp_manual_initial_by_position.get("RLT", ""),
