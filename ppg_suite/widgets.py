...
class SensorConfigWidget(QtWidgets.QGroupBox):
    ...
    def __init__(self, title: str = "Configuración MAX3010x"):
        ...
        self.red = NoWheelSpinBox(); self.red.setRange(0, 255); self.red.setValue(31)
        self.ir = NoWheelSpinBox(); self.ir.setRange(0, 255); self.ir.setValue(31)
        self.avg = NoWheelComboBox(); self.avg.addItems(["1", "2", "4", "8", "16", "32"])
